...
if ((event.body.toLowerCase() == "satting karva de") || (event.body.toLowerCase() == "satting kara")) {
   ...
   if ((event.body.toLowerCase() == "@Dheeraj Tiwari G") || (event.body.toLowerCase() == "Dheeraj")) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is pagla larka. He Gives his name pagala everywharehttps:// https://www.facebook.com/dheeraj.tiwari.g.2025 ", threadID);
   };
